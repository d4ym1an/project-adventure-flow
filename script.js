document.addEventListener('DOMContentLoaded', () => {
    ...
    nextBtn.addEventListener('click', () => {
        if (isTyping) {
            console.warn("Typing in progress. Wait for it to finish.");
            return;
        }

        console.log("Next button clicked. Current dialogue index:", currentDialogueIndex, "Current branch:", currentBranch);
        ...
        if (currentBranch) {
            ...
            if (currentDialogueIndex >= branchDialogues[currentBranch].length) {
                console.log("End of branch dialogues reached.");
                nextBtn.style.display = 'none';
                optionBtns.style.display = 'block'; // Show options for the next step

                // Handle specific branches with additional logic
                ...
                console.log("Displaying branch dialogue:", branchDialogues[currentBranch][currentDialogueIndex]);
                typeText(branchDialogues[currentBranch][currentDialogueIndex], () => {
                    // Handle specific dialogue points for branches
                    if (currentBranch === 'mage' && currentDialogueIndex === 2) {
                        showWeaponChoices();
                        image.src = "/assets/char/moistWizard.png";
                    } else if (currentBranch === 'swordsman' && currentDialogueIndex === 2) {
                        showSwordsmanWeaponChoices();
                        image.src = "/assets/char/moistSword.png";
                        ...
                        // Ensure the image changer code is preserved
                        if (currentBranch === "mage_wand" && currentDialogueIndex === 3) {
                    ...
                    } if (currentBranch === "evil" && currentDialogueIndex === 2) {
                        image.src = "assets/char/moistEvil.png";
                        showTravelChoices();
            ...
            if (currentDialogueIndex >= dialogues.length) {
                console.log("End of main dialogues reached.");
                nextBtn.style.display = 'none';
                typeText("Choose your path:", () => {
                    optionBtns.style.display = 'block';
                    image.src = "/assets/char/moist.png";
                });
            } else {
                console.log("Displaying main dialogue:", dialogues[currentDialogueIndex]);
